...
public class App {
   ...
   public static void configureRoutes(Javalin app) {
      ...
      app.get(Application.URL, new Application());
      app.get(Accommodation.URL, new Accommodation());
      app.get(Reviews.URL, new Reviews());

      // Add / uncomment POST commands for any pages that need web form POSTS
      app.post(Application.URL, new Application());
      app.post(Accommodation.URL, new Accommodation());
      app.post(Reviews.URL, new Reviews());
   }
